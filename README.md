I usually go by Sinon online. I'm a 12th grader writing the RISC-V backend for [Zig](https://github.com/ziglang/zig) and doing ML inference at [ZML](https://github.com/zml).
...
- [Synthetic Navigation](https://github.com/Rexicon226/Synthetic-Navigation) A De-fuzzing neural network I wrote in 9th grade. Sort of my entry into the world of machine learning. Wrote a paper about it as well for a science fair, it's in the repo.
- [Space Warp](https://github.com/SpaceWarpDev/SpaceWarp) KSP2 Modding API. (Not my project, but I helped :)
